...
namespace MSFTBandLib.Helpers
{
    ...
    public static class TimeHelper
    {
        ...
        public static DateTime DateTimeUshorts(ushort[] t) => new DateTime(t[0], t[1], t[2], t[3], t[4], t[5]);
        ...
        public static DateTime DateTimeResponse(
            ICommandResponse response, int position = 0)
        {
            var t = response.GetByteStream().GetUshorts(8, position);
            var times = new List<ushort>(t);
            times.RemoveAt(2);
            return DateTimeUshorts(times.ToArray());
        }
    }
}